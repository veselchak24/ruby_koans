...
It was the worst of times.
    ...
    assert_equal 25 + 25 + 4, long_string.length
...
It was the worst of times.
EOS
    assert_equal 25 + 25 + 3, long_string.length
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified
    ...
    hi = original_string
    there = "World"
    hi += there # create new variable. hi = hi+there
